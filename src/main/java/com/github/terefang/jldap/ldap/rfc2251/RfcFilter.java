...
import com.github.terefang.jldap.ldap.LDAPSearchRequest;
...
public class RfcFilter extends ASN1Choice
{
     ...
     * @throws com.github.terefang.jldap.ldap.LDAPLocalException
...
/**
     ...
     * @throws com.github.terefang.jldap.ldap.LDAPLocalException  Occurs when the specified
  ...
  */
    ...
    private static String byteString(byte[] value) {
        ...
        if (com.github.terefang.jldap.ldap.util.Base64.isValidUTF8(value, true)) {
            try {
