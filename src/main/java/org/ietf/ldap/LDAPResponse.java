...
{
    private com.github.terefang.jldap.ldap.LDAPResponse response;

    /**
     * Creates an LDAPResponse from a com.novell.ldap.LDAPResponse object
     */
    public LDAPResponse( com.github.terefang.jldap.ldap.LDAPResponse response)
    {
        super( response);
    ...
    public LDAPControl[] getControls() {
		com.github.terefang.jldap.ldap.LDAPControl[] controls = response.getControls();
        if( controls == null) {
            return null;
        }
