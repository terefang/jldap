...
{
    private com.github.terefang.jldap.ldap.LDAPConnection conn;
    ...
    public static final int SCOPE_BASE =
                            com.github.terefang.jldap.ldap.LDAPConnection.SCOPE_BASE;
    ...
    public static final int SCOPE_ONE =
                            com.github.terefang.jldap.ldap.LDAPConnection.SCOPE_ONE;
    ...
    public static final int SCOPE_SUB =
                            com.github.terefang.jldap.ldap.LDAPConnection.SCOPE_SUB;
    ...
    public static final int SCOPE_SUBORDINATESUBTREE =
                            com.github.terefang.jldap.ldap.LDAPConnection.SCOPE_SUBORDINATESUBTREE;
    ...
    public static final String NO_ATTRS =
                            com.github.terefang.jldap.ldap.LDAPConnection.NO_ATTRS;
    ...
    public static final String ALL_USER_ATTRS =
                            com.github.terefang.jldap.ldap.LDAPConnection.ALL_USER_ATTRS;
    ...
    public static final int DEFAULT_PORT =
                            com.github.terefang.jldap.ldap.LDAPConnection.DEFAULT_PORT;
    ...
    public static final String LDAP_PROPERTY_SDK =
                            com.github.terefang.jldap.ldap.LDAPConnection.LDAP_PROPERTY_SDK;
    ...
    public static final String LDAP_PROPERTY_PROTOCOL =
                          com.github.terefang.jldap.ldap.LDAPConnection.LDAP_PROPERTY_PROTOCOL;
    ...
    public static final String LDAP_PROPERTY_SECURITY =
                          com.github.terefang.jldap.ldap.LDAPConnection.LDAP_PROPERTY_SECURITY;
    ...
    {
        conn = new com.github.terefang.jldap.ldap.LDAPConnection();
        return;
    }
     ...
     */
    /* package */
    LDAPConnection( com.github.terefang.jldap.ldap.LDAPConnection conn)
    {
        this.conn = conn;
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPConnection getWrappedObject()
    {
        return conn;
    }
     ...
     */
    private
    interface SocketFactoryWrapper extends com.github.terefang.jldap.ldap.LDAPSocketFactory
    {
        /**
     ...
     */
    private
    static com.github.terefang.jldap.ldap.LDAPSocketFactory getSocketImpl(LDAPSocketFactory f)
    {
    ...
    {
        if( (factory != null) &&
                (factory instanceof com.github.terefang.jldap.ldap.LDAPSocketFactory)) {
            conn = new com.github.terefang.jldap.ldap.LDAPConnection(
                                   (com.github.terefang.jldap.ldap.LDAPSocketFactory)factory);
        } else {
            conn = new com.github.terefang.jldap.ldap.LDAPConnection( getSocketImpl(factory));
        }
        return;
    }
            ...
            throws CloneNotSupportedException
    {
        try {
            ...
            ((LDAPConnection)newObj).conn = (com.github.terefang.jldap.ldap.LDAPConnection)conn.clone();
            return newObj;
        ...
        throws LDAPException
    {
        try {
            conn.disconnect();
        } catch ( com.github.terefang.jldap.ldap.LDAPException ex) {
    ...
    {
        com.github.terefang.jldap.ldap.LDAPSocketFactory factory = conn.getSocketFactory();
        if( factory == null) {
            return null;
        }
    ...
    public static void setSocketFactory( LDAPSocketFactory factory)
    {
        if( (factory != null) &&
                (factory instanceof com.github.terefang.jldap.ldap.LDAPSocketFactory)) {
            com.github.terefang.jldap.ldap.LDAPConnection.setSocketFactory(
                                    (com.github.terefang.jldap.ldap.LDAPSocketFactory)factory);
        } else {
            com.github.terefang.jldap.ldap.LDAPConnection.setSocketFactory(
    ...
    private class UnsolImpl
            implements com.github.terefang.jldap.ldap.LDAPUnsolicitedNotificationListener
    {
        ...
        public void messageReceived( com.github.terefang.jldap.ldap.LDAPExtendedResponse msg)
        {
                        ...
                        LDAPUnsolicitedNotificationListener queue)
    {
        ...
        com.github.terefang.jldap.ldap.LDAPUnsolicitedNotificationListener ul = null;

        if (queue != null) {
            synchronized( listenerQueues) {
                ul = (com.github.terefang.jldap.ldap.LDAPUnsolicitedNotificationListener)
        ...
        throws LDAPException
    {
        try {
            if( results == null) {
                conn.abandon( (com.github.terefang.jldap.ldap.LDAPSearchResults)null);
            } else {
        ...
        throws LDAPException
    {
        try {
            ...
            if( ex instanceof com.github.terefang.jldap.ldap.LDAPReferralException) {
                throw new LDAPReferralException(
                        (com.github.terefang.jldap.ldap.LDAPReferralException)ex);
            } else {
                throw new LDAPException( ex);
            }
        }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPControl[] controls = conn.getResponseControls();
        if( controls == null) {
            return null;
        }
    ...
    {
        try {
            com.github.terefang.jldap.ldap.LDAPModification[] lmods =
                            new com.github.terefang.jldap.ldap.LDAPModification[mods.length];
    ...
    {
        try {
            return new LDAPEntry( com.github.terefang.jldap.ldap.LDAPConnection.read(
        ...
        throws LDAPException
    {
        try {
            return new LDAPEntry(
                    com.github.terefang.jldap.ldap.LDAPConnection.read(
                                       toGet.getWrappedObject(),
                                       cons.getWrappedSearchObject()));
        } catch( com.github.terefang.jldap.ldap.LDAPException ex) {
            if( ex instanceof com.github.terefang.jldap.ldap.LDAPReferralException) {
        ...
        throws LDAPException
    {
        try {
            return new LDAPSearchResults(
                        com.github.terefang.jldap.ldap.LDAPConnection.search(
                                            toGet.getWrappedObject()));
        } catch( com.github.terefang.jldap.ldap.LDAPException ex) {
            if( ex instanceof com.github.terefang.jldap.ldap.LDAPReferralException) {
                throw new LDAPReferralException(
    ...
    public LDAPSchema fetchSchema(String schemaDN) throws LDAPException {
        ...
        catch (com.github.terefang.jldap.ldap.LDAPException novellException){
