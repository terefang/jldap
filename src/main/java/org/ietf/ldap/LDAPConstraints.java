...
{
    private com.github.terefang.jldap.ldap.LDAPConstraints cons;
    private com.github.terefang.jldap.ldap.LDAPReferralHandler refHandler = null;

    /**
     * Constructs LDAPConstraints from a com.novell.ldap.LDAPConstraints
     */
    /* package */
    LDAPConstraints( com.github.terefang.jldap.ldap.LDAPConstraints cons)
    {
    ...
    LDAPConstraints( LDAPConstraints cons)
    {
        ...
        if( cons instanceof LDAPSearchConstraints) {
            ...
            com.github.terefang.jldap.ldap.LDAPSearchConstraints outCons =
                            (com.github.terefang.jldap.ldap.LDAPSearchConstraints)this.cons;
    ...
    public Object clone()
    {
        try {
            ...
            ((LDAPConstraints)newObj).cons = (com.github.terefang.jldap.ldap.LDAPConstraints)this.cons.clone();
            return newObj;
    ...
    {
        cons = new com.github.terefang.jldap.ldap.LDAPSearchConstraints();
        return;
    }
     ...
     *
     * @see com.github.terefang.jldap.ldap.LDAPConstraints#LDAPConstraints(
                           ...
                           int hop_limit)
    {
        ...
        this.cons = new com.github.terefang.jldap.ldap.LDAPSearchConstraints();
     ...
     */
    private class BindHandlerImpl implements com.github.terefang.jldap.ldap.LDAPBindHandler
    {
        LDAPBindHandler ref;
        ...
        public com.github.terefang.jldap.ldap.LDAPConnection bind(String[] ldapurl,
                                                                  com.github.terefang.jldap.ldap.LDAPConnection conn)
                throws com.github.terefang.jldap.ldap.LDAPReferralException
        {
            ...
            try {
                ...
                if( newconn == null) {
                    return (com.github.terefang.jldap.ldap.LDAPConnection)null;
                }
                return newconn.getWrappedObject();
            } catch( LDAPReferralException rex) {
                throw (com.github.terefang.jldap.ldap.LDAPReferralException)
                                                         rex.getWrappedObject();
            } catch( Throwable ex) {
                throw new com.github.terefang.jldap.ldap.LDAPReferralException( ex.toString(),
                                                                 ex);
            }
        }
    }
     ...
     */
    private class AuthHandlerImpl implements com.github.terefang.jldap.ldap.LDAPAuthHandler
    {
        LDAPAuthHandler ref;
        ...
        public com.github.terefang.jldap.ldap.LDAPAuthProvider getAuthProvider(
                                                        String host,
                                                        int port)
        {
            ...
            if( auth == null) {
                return (com.github.terefang.jldap.ldap.LDAPAuthProvider)null;
            }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPConstraints getWrappedObject()
    {
        return cons;
    }
    ...
    {
        if( handler == null) {
            cons.setReferralHandler((com.github.terefang.jldap.ldap.LDAPReferralHandler)null);
            refHandler = null;
        } else
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPReferralHandler getReferralHandler()
    {
        return refHandler;
    }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPControl[] controls = cons.getControls();
        if( controls == null) {
            return null;
        }
                ...
                throws LDAPException
    {
        ...
        } catch( com.github.terefang.jldap.ldap.LDAPException rex) {
