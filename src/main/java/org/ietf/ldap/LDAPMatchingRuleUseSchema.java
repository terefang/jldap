...
{
    private com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema schema;

    /**
     * Constructs LDAPMatchingRuleUseSchema from com.novell.ldap
     */
    /* package */
    LDAPMatchingRuleUseSchema( com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema schema)
    {
        super( schema);
        this.schema = schema;
        return;
    ...
    public LDAPMatchingRuleUseSchema(String[] names,
                                     ...
                                     String[] attributes)
    {
        super( new com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema( names,
                                                              oid,
                                                              description,
                                                              obsolete,
                                                              attributes));
        schema = (com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema)getWrappedObject();
        return;
    }
