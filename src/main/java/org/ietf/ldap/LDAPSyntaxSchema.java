...
{
    com.github.terefang.jldap.ldap.LDAPSyntaxSchema schema;

    /**
     * Constructs LDAPAttributeSchema from com.novell.ldap.LDAPAttributeSchema
     */
    /* package */
    LDAPSyntaxSchema( com.github.terefang.jldap.ldap.LDAPSyntaxSchema schema)
    {
        super( schema);
        this.schema = schema;
        return;
    ...
    public LDAPSyntaxSchema(String oid,
                            String description)
    {
        super( new com.github.terefang.jldap.ldap.LDAPSyntaxSchema( oid, description));
        schema = (com.github.terefang.jldap.ldap.LDAPSyntaxSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPSyntaxSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPSyntaxSchema)getWrappedObject();
        return;
    }
}
