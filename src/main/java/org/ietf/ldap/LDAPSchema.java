...
public class LDAPSchema extends LDAPEntry
{
    ...
    private com.github.terefang.jldap.ldap.LDAPSchema schema;

    /*package*/
    LDAPSchema( com.github.terefang.jldap.ldap.LDAPSchema novellschema){
        schema = novellschema;
        return;
    }
    ...
    {
        schema = new com.github.terefang.jldap.ldap.LDAPSchema(entry.getWrappedObject());
        return;
    }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPAttributeSchema attr = schema.getAttributeSchema( name);
        if( attr == null) {
            return null;
        }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPObjectClassSchema obj = schema.getObjectClassSchema(name);
        if( obj == null) {
            return null;
        }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema match =
    ...
    {
        com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema match =
    ...
    {
        com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema rule =
    ...
    {
        com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema rule =
    ...
    {
        com.github.terefang.jldap.ldap.LDAPNameFormSchema form =
    ...
    {
        com.github.terefang.jldap.ldap.LDAPSyntaxSchema syntax =
        ...
        class AttrEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPAttributeSchema(
                    (com.github.terefang.jldap.ldap.LDAPAttributeSchema)enumer.nextElement());
            }
        }
        ...
        class ObjEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPObjectClassSchema(
                    (com.github.terefang.jldap.ldap.LDAPObjectClassSchema)enumer.nextElement());
            }
        }
        ...
        class MatchEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPMatchingRuleSchema(
                    (com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema)enumer.nextElement());
            }
        }
        ...
        class UseEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPMatchingRuleUseSchema(
                 (com.github.terefang.jldap.ldap.LDAPMatchingRuleUseSchema)enumer.nextElement());
            }
        }
        ...
        class StructEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
              return new LDAPDITStructureRuleSchema(
                (com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema)enumer.nextElement());
            }
        }
        ...
        class ContentEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPDITContentRuleSchema(
                  (com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema)enumer.nextElement());
            }
        }
        ...
        class NameEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPNameFormSchema(
                        (com.github.terefang.jldap.ldap.LDAPNameFormSchema)enumer.nextElement());
            }
        }
        ...
        class SyntaxEnumWrapper implements Enumeration
        {
            ...
            public Object nextElement() throws NoSuchElementException
            {
                return new LDAPSyntaxSchema(
                        (com.github.terefang.jldap.ldap.LDAPSyntaxSchema)enumer.nextElement());
            }
        }
