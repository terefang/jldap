...
{
    private com.github.terefang.jldap.ldap.LDAPReferralException exception;
    /**
     * Constructs a referral exception from a
     * com.novell.ldap.LDAPREferralException
     *
     */
    public LDAPReferralException( com.github.terefang.jldap.ldap.LDAPReferralException ex)
    {
        super(ex);
        exception = ex;
        return;
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPReferralException());
        exception = (com.github.terefang.jldap.ldap.LDAPReferralException)
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPReferralException(message));
        exception = (com.github.terefang.jldap.ldap.LDAPReferralException)
                                                       super.getWrappedObject();
        return;
    }
    ...
    {
        super(new com.github.terefang.jldap.ldap.LDAPReferralException(message,rootException));
        exception = (com.github.terefang.jldap.ldap.LDAPReferralException)
                                                       super.getWrappedObject();
        return;
    }
