...
{
    private com.github.terefang.jldap.ldap.LDAPSearchConstraints cons =
            new com.github.terefang.jldap.ldap.LDAPSearchConstraints();
    ...
    public static final int DEREF_NEVER  = 
                com.github.terefang.jldap.ldap.LDAPSearchConstraints.DEREF_NEVER;
    ...
    public static final int DEREF_SEARCHING = 
                com.github.terefang.jldap.ldap.LDAPSearchConstraints.DEREF_SEARCHING;
    ...
    public static final int DEREF_FINDING = 
                com.github.terefang.jldap.ldap.LDAPSearchConstraints.DEREF_FINDING;
    ...
    public static final int DEREF_ALWAYS = 
                com.github.terefang.jldap.ldap.LDAPSearchConstraints.DEREF_ALWAYS;
     ...
     */
    /* package */
    LDAPSearchConstraints( com.github.terefang.jldap.ldap.LDAPSearchConstraints cons)
    {
        super( cons);
        this.cons = cons;
        return;
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPSearchConstraints());
        cons = (com.github.terefang.jldap.ldap.LDAPSearchConstraints)super.getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPSearchConstraints( cons.getWrappedObject()));
        this.cons = (com.github.terefang.jldap.ldap.LDAPSearchConstraints)super.getWrappedObject();
        return;
    }
     ...
     */
    com.github.terefang.jldap.ldap.LDAPSearchConstraints getWrappedSearchObject()
    {
        return cons;
    }
