...
{
    private com.github.terefang.jldap.ldap.LDAPAttribute attr;

    /**
     * Constructs an attribute from a com.novell.ldap.LDAPAttribute
     */
    /* package */
    LDAPAttribute(com.github.terefang.jldap.ldap.LDAPAttribute attr)
    {
       if( attr == null) {
            throw new 
    ...
    {
        com.github.terefang.jldap.ldap.LDAPAttribute at = null;
        if( attr != null) {
            at = attr.getWrappedObject();
        }
        this.attr = new com.github.terefang.jldap.ldap.LDAPAttribute(at);
        return;
    }
    ...
    {
        this.attr = new com.github.terefang.jldap.ldap.LDAPAttribute(attrName);
        return;
    }
    ...
    {
        this.attr = new com.github.terefang.jldap.ldap.LDAPAttribute(attrName, attrBytes);
        return;
    }
    ...
    {
        this.attr = new com.github.terefang.jldap.ldap.LDAPAttribute(attrName, attrString);
        return;
    }
    ...
    {
        this.attr = new com.github.terefang.jldap.ldap.LDAPAttribute(attrName, attrStrings);
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPAttribute getWrappedObject()
    {
        return attr;
    }
    ...
    {
        return com.github.terefang.jldap.ldap.LDAPAttribute.getBaseName(attrName);
    }
    ...
    {
        return com.github.terefang.jldap.ldap.LDAPAttribute.getSubtypes(attrName);
    }
    ...
    public Object clone()
    {
        try {
            ...
            ((LDAPAttribute)newObj).attr = (com.github.terefang.jldap.ldap.LDAPAttribute)this.attr.clone();
            return newObj;
