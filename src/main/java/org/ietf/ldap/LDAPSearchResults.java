...
{
    private com.github.terefang.jldap.ldap.LDAPSearchResults results;

    /**
     * Constructs searchResults from a com.novell.ldap.LDAPSearchResults object
     */
    /* package */
    LDAPSearchResults( com.github.terefang.jldap.ldap.LDAPSearchResults results)
    {
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPSearchResults getWrappedObject()
    {
        return results;
    }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPControl[] controls = results.getResponseControls();
        if( controls == null) {
            return null;
        }
