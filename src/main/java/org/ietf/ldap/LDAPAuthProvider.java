...
{
    com.github.terefang.jldap.ldap.LDAPAuthProvider auth;
    /**
    ...
    {
        auth = new com.github.terefang.jldap.ldap.LDAPAuthProvider( dn, password);
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPAuthProvider getWrappedObject()
    {
        return auth;
    }
