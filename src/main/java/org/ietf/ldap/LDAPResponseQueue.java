...
{
    private com.github.terefang.jldap.ldap.LDAPResponseQueue queue;

    /**
     * Constructs a response queue from com.novell.ldap.LDAPResponseQueue
     */
    /* package */
    LDAPResponseQueue(com.github.terefang.jldap.ldap.LDAPResponseQueue queue)
    {
        this.queue = queue;
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPResponseQueue getWrappedObject()
    {
        return queue;
    }
     ...
     */
     ...
     {
        if( queue2 == null) {
            queue.merge( (com.github.terefang.jldap.ldap.LDAPMessageQueue)null);
        }
