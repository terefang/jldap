...
public class LDAPUrl implements Cloneable {
    ...
    private com.github.terefang.jldap.ldap.LDAPUrl url;
    ...
    {
        this.url = new com.github.terefang.jldap.ldap.LDAPUrl( url);
        return;
    }
    ...
    {
		url = new com.github.terefang.jldap.ldap.LDAPUrl( host, port, dn);
		return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPUrl getWrappedObject()
    {
        return url;
    }
