...
public class LDAPDN
{
    ...
    */
    ...
    {
        return com.github.terefang.jldap.ldap.LDAPDN.equals(dn1, dn2);
    }
    ...
    {
        return com.github.terefang.jldap.ldap.LDAPDN.escapeRDN(rdn);
    }
    ...
    {
        return com.github.terefang.jldap.ldap.LDAPDN.explodeDN(dn,noTypes);
    }
    ...
    public static String[] explodeRDN(String rdn, boolean noTypes) {
        return com.github.terefang.jldap.ldap.LDAPDN.explodeRDN(rdn,noTypes);
    }
    ...
    public static boolean isValid(String dn){
        return com.github.terefang.jldap.ldap.LDAPDN.isValid(dn);
    }
    ...
    public static String normalize(String dn){
        return com.github.terefang.jldap.ldap.LDAPDN.normalize(dn);
    }
    ...
    public static String unescapeRDN (String rdn) {
        return com.github.terefang.jldap.ldap.LDAPDN.unescapeRDN(rdn);
    }
}
