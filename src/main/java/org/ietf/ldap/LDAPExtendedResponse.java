...
public class LDAPExtendedResponse extends LDAPResponse {
    ...
    com.github.terefang.jldap.ldap.LDAPExtendedResponse response;
     ...
     */
    /* package */
    LDAPExtendedResponse(com.github.terefang.jldap.ldap.LDAPExtendedResponse response)
    {
        super( response);
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPExtendedResponse getWrappedObject()
    {
        return response;
    }
