...
{
    private com.github.terefang.jldap.ldap.LDAPSearchQueue queue;

    /**
     * Constructs a response queue from a com.novell.ldap.LDAPSearchQueue
     */
    /* package */
    LDAPSearchQueue(com.github.terefang.jldap.ldap.LDAPSearchQueue queue)
    {
        this.queue = queue;
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPSearchQueue getWrappedObject()
    {
        return queue;
    }
