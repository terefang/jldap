...
public class LDAPAttributeSet implements java.lang.Cloneable,
                                         java.util.Set
{
    private com.github.terefang.jldap.ldap.LDAPAttributeSet attrSet;

    /**
     * Constructs a new set of attributes, using an existing attribute set.
     */
    /* package */
    LDAPAttributeSet( com.github.terefang.jldap.ldap.LDAPAttributeSet attrSet)
    {
    ...
    {
        attrSet = new com.github.terefang.jldap.ldap.LDAPAttributeSet();
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPAttributeSet getWrappedObject()
    {
        return attrSet;
    }
            ...
            throws CloneNotSupportedException
    {
        try {
            ...
            ((LDAPAttributeSet)newObj).attrSet = (com.github.terefang.jldap.ldap.LDAPAttributeSet)attrSet.clone();
            return newObj;
    ...
    {
        com.github.terefang.jldap.ldap.LDAPAttribute attr;
...
// ################### Methods to implement Set ##########################
    ...
    {
        com.github.terefang.jldap.ldap.LDAPAttribute a;
    ...
    {
        com.github.terefang.jldap.ldap.LDAPAttributeSet aset =
    ...
    public Object[] toArray( Object[] a)
    {
        ...
        com.github.terefang.jldap.ldap.LDAPAttribute[] oldAttrs;
        oldAttrs = (com.github.terefang.jldap.ldap.LDAPAttribute[])attrSet.toArray(
                new com.github.terefang.jldap.ldap.LDAPAttribute[attrSet.size()]);
...
private static final class WrappedIterator implements Iterator { 
    ...
    public Object next() { 
      com.github.terefang.jldap.ldap.LDAPAttribute attr =
        (com.github.terefang.jldap.ldap.LDAPAttribute) this.iterator.next();
      return new LDAPAttribute(attr);
    }
