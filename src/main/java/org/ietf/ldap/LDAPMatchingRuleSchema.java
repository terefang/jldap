...
public class LDAPMatchingRuleSchema extends LDAPSchemaElement
{
    ...
    private com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema schema;

    /**
     * Constructs LDAPMatchingRuleSchema from com.novell.ldap
     */
    /* package */
    LDAPMatchingRuleSchema( com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema schema)
    {
        super( schema);
        this.schema = schema;
        return;
    ...
    public LDAPMatchingRuleSchema(String names[],
                                  ...
                                  String syntaxString)
    {
        super( new com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema( names,
                                                           oid,
                                                           description,
                                                           attributes,
                                                           obsolete,
                                                           syntaxString));
        schema = (com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema( rawMatchingRule,
                                                           rawMatchingRuleUse));
        schema = (com.github.terefang.jldap.ldap.LDAPMatchingRuleSchema)getWrappedObject();
        return;
    }
