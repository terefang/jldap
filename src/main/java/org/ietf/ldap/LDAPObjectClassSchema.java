...
{
    private com.github.terefang.jldap.ldap.LDAPObjectClassSchema schema;
     ...
     */
     public final static int ABSTRACT =
                com.github.terefang.jldap.ldap.LDAPObjectClassSchema.ABSTRACT;
     ...
     */
     public final static int STRUCTURAL =
                com.github.terefang.jldap.ldap.LDAPObjectClassSchema.STRUCTURAL;
     ...
     */
     public final static int AUXILIARY =
                com.github.terefang.jldap.ldap.LDAPObjectClassSchema.AUXILIARY;
    ...
    public LDAPObjectClassSchema(String[] names,
                                 ...
                                 boolean obsolete)
    {
        super( new com.github.terefang.jldap.ldap.LDAPObjectClassSchema( names,
                                                          oid,
                                                          superiors,
                                                          description,
                                                          required,
                                                          ...
                                                          type,
                                                          obsolete));
        schema = (com.github.terefang.jldap.ldap.LDAPObjectClassSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPObjectClassSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPObjectClassSchema)getWrappedObject();
        return;
    }
     ...
     */
    /* package */
    LDAPObjectClassSchema( com.github.terefang.jldap.ldap.LDAPObjectClassSchema schema)
    {
        super(schema);
        this.schema = schema;
        return;
