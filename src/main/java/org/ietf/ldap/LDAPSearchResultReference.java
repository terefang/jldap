...
public class LDAPSearchResultReference extends LDAPMessage {
    ...
    private com.github.terefang.jldap.ldap.LDAPSearchResultReference ref;
	/**
     * Constructs an LDAPSearchResultReference object.
     *
	 */
	/*package*/
	LDAPSearchResultReference( com.github.terefang.jldap.ldap.LDAPSearchResultReference ref)
	{
        super(ref);
        this.ref = ref;
        return;
