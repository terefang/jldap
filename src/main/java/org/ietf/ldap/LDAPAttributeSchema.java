...
public class LDAPAttributeSchema extends LDAPSchemaElement
{
    ...
    private com.github.terefang.jldap.ldap.LDAPAttributeSchema schema;
    /**
    ...
    public final static int USER_APPLICATIONS =
            com.github.terefang.jldap.ldap.LDAPAttributeSchema.USER_APPLICATIONS;
    /**
    ...
    public final static int DIRECTORY_OPERATION =
            com.github.terefang.jldap.ldap.LDAPAttributeSchema.DIRECTORY_OPERATION;
    /**
    ...
    public final static int DISTRIBUTED_OPERATION =
            com.github.terefang.jldap.ldap.LDAPAttributeSchema.DISTRIBUTED_OPERATION;
    /**
    ...
    public final static int DSA_OPERATION =
            com.github.terefang.jldap.ldap.LDAPAttributeSchema.DSA_OPERATION;

    /**
     * Constructs LDAPAttributeSchema from com.novell.ldap.LDAPAttributeSchema
     */
    /* package */
    LDAPAttributeSchema( com.github.terefang.jldap.ldap.LDAPAttributeSchema schema)
    {
        super( schema);
        this.schema = schema;
        return;
    ...
    public LDAPAttributeSchema(String[] names, String oid, String description,
                  ...
                  int usage)
    {
        super( new com.github.terefang.jldap.ldap.LDAPAttributeSchema(names, oid, description,
               syntaxString, single, superior, obsolete,
               equality, ordering, substring, collective, userMod, usage));
        schema = (com.github.terefang.jldap.ldap.LDAPAttributeSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPAttributeSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPAttributeSchema)getWrappedObject();
        return;
    }
