...
public class LDAPExtendedOperation implements Cloneable
{
	 ...
	 */
	/* package */
	com.github.terefang.jldap.ldap.LDAPExtendedOperation getWrappedObject()
	{
		return exop;
	}
    ...
    private class ExOp extends com.github.terefang.jldap.ldap.LDAPExtendedOperation
    {
        /**
         * Constructs a new object with the specified object ID and data.
         *
         * @see com.github.terefang.jldap.ldap.LDAPExtendedOperation
         */
