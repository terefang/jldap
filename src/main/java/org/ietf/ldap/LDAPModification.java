...
{
    private com.github.terefang.jldap.ldap.LDAPModification mod;
     ...
     */
    /* package */
	LDAPModification(com.github.terefang.jldap.ldap.LDAPModification mod)
    {
        this.mod = mod;
        return;
    }
    ...
    {
        mod = new com.github.terefang.jldap.ldap.LDAPModification(op, attr.getWrappedObject());
        return;
    }
     ...
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPModification getWrappedObject()
    {
        return mod;
    }
