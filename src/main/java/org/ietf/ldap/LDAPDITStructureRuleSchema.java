...
{
    private com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema schema;
                                      ...
                                      String[] superiorIDs)
    {
        ...
        super( new com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema( names,
                                                               ruleID,
                                                               description,
                                                               obsolete,
                                                               nameForm,
                                                               superiorIDs));
        schema = (com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPDITStructureRuleSchema)getWrappedObject();
        return;
    }
