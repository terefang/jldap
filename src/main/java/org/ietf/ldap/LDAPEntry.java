...
{
    private com.github.terefang.jldap.ldap.LDAPEntry entry;
    /**
     * Constructs an Entry from com.novell.ldap.LDAPEntry
     */
    /* package */
    LDAPEntry( com.github.terefang.jldap.ldap.LDAPEntry entry)
    {
        this.entry = entry;
        return;
    }
    ...
    public LDAPEntry()
    {
        entry = new com.github.terefang.jldap.ldap.LDAPEntry();
        return;
    }
    ...
    {
        entry = new com.github.terefang.jldap.ldap.LDAPEntry(dn);
        return;
    }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPAttributeSet attrset = null;
        if( attrs != null) {
            attrset = attrs.getWrappedObject();
        }
        entry = new com.github.terefang.jldap.ldap.LDAPEntry(dn, attrset);
        return;
    }
     ...
     */
    com.github.terefang.jldap.ldap.LDAPEntry getWrappedObject()
    {
        return entry;
    }
