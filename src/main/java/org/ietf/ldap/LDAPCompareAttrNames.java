...
public class LDAPCompareAttrNames implements java.util.Comparator
{
    ...
    private com.github.terefang.jldap.ldap.LDAPCompareAttrNames comp;

    /**
     * Returns the com.novell.ldap.LDAPCompareAttrNames object
     */
    /* package */
    com.github.terefang.jldap.ldap.LDAPCompareAttrNames getWrappedObject()
    {
        return comp;
    }
    ...
    {
        comp = new com.github.terefang.jldap.ldap.LDAPCompareAttrNames( attrName);
        return;
    }
    ...
    {
        comp = new com.github.terefang.jldap.ldap.LDAPCompareAttrNames(
    ...
    {
        comp = new com.github.terefang.jldap.ldap.LDAPCompareAttrNames( attrNames);
        return;
    }
    ...
    {
        com.github.terefang.jldap.ldap.LDAPEntry e1 = ((LDAPEntry) entry1).getWrappedObject();
        com.github.terefang.jldap.ldap.LDAPEntry e2 = ((LDAPEntry) entry2).getWrappedObject();
