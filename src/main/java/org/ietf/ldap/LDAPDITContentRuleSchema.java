...
{
    private com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema schema;

    /**
     * Constructs LDAPAttributeSchema from com.novell.ldap.LDAPAttributeSchema
     */
    /* package */
    LDAPDITContentRuleSchema( com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema schema)
    {
        super( schema);
        this.schema = schema;
        return;
    ...
    public LDAPDITContentRuleSchema(String[] names,
                                    ...
                                    String[] precluded)
    {
        super( new com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema( names,
                                                          oid,
                                                          description,
                                                          obsolete,
                                                          auxiliary,
                                                          ...
                                                          optional,
                                                          precluded));
        schema = (com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPDITContentRuleSchema)getWrappedObject();
        return;
    }
