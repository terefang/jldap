...
{
	private com.github.terefang.jldap.ldap.LDAPNameFormSchema schema;

    /**
     * Constructs LDAPAttributeSchema from com.novell.ldap.LDAPAttributeSchema
     */
    /* package */
    LDAPNameFormSchema( com.github.terefang.jldap.ldap.LDAPNameFormSchema schema)
    {
        super( schema);
        this.schema = schema;
        return;
    ...
    public LDAPNameFormSchema(String[] names,
                              ...
                              String[] optional)
    {
        super( new com.github.terefang.jldap.ldap.LDAPNameFormSchema( names,
                                                       oid,
                                                       description,
                                                       obsolete,
                                                       objectClass,
                                                       required,
                                                       optional));
        schema = (com.github.terefang.jldap.ldap.LDAPNameFormSchema)getWrappedObject();
        return;
    }
    ...
    {
        super( new com.github.terefang.jldap.ldap.LDAPNameFormSchema( raw));
        schema = (com.github.terefang.jldap.ldap.LDAPNameFormSchema)getWrappedObject();
        return;
    }
